              ...
              <div className="space-y-2">
                <details className="group rounded-lg border border-gray-200 shadow-md">
                  <summary className="flex items-center justify-between p-3 rounded-lg cursor-pointer">
                    <h5 className="font-bold">📌 كيف يمكنني التسجيل في التدريب؟</h5>
                ...
                <details className="group rounded-lg border border-gray-200 shadow-md">
                  <summary className="flex items-center justify-between p-3 rounded-lg cursor-pointer">
                    <h5 className="font-bold">💳 ما هي طرق الدفع المتاحة؟</h5>
                    <svg className="flex-shrink-0 mx-1 w-5 h-5 transition duration-300 group-open:-rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                ...
                <details className="group rounded-lg border border-gray-200 shadow-md">
                  <summary className="flex items-center justify-between p-3 rounded-lg cursor-pointer">
                    <h5 className="font-bold">🤔 هل يجب أن أكون متمكناً من البرمجة قبل البدء؟</h5>
                    <svg className="flex-shrink-0 mx-1 w-5 h-5 transition duration-300 group-open:-rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                ...
                <details className="group rounded-lg border border-gray-200 shadow-md">
                  <summary className="flex items-center justify-between p-3 rounded-lg cursor-pointer">
                    <h5 className="font-bold">🏡 هل يجب أن أذهب إلى مكان معين لحضور التدريب؟</h5>
                    <svg className="flex-shrink-0 mx-1 w-5 h-5 transition duration-300 group-open:-rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                ...
                <details className="group rounded-lg border border-gray-200 shadow-md">
                  <summary className="flex items-center justify-between p-3 rounded-lg cursor-pointer">
                    <h5 className="font-bold">🎯 لماذا هذا التدريب هو الخيار المثالي لك؟</h5>
                    <svg className="flex-shrink-0 mx-1 w-5 h-5 transition duration-300 group-open:-rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
